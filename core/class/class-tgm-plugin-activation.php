...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function install_plugins_page() {
			...
			$plugin_table = new \annonces\TGMPA_List_Table;
			...
			if ( ! empty( $message ) || $total_required_action_count > 0 ) {
				...
				if ( ! current_user_can( 'activate_plugins' ) && ! current_user_can( 'install_plugins' ) && ! current_user_can( 'update_plugins' ) ) {
					...
					foreach ( $message as $type => $plugin_group ) {
						...
						$linked_plugins = array_map( array( '\annonces\TGMPA_Utils', 'wrap_in_em' ), $linked_plugins );
	...
	if ( did_action( 'plugins_loaded' ) ) {
		...
		add_action( 'plugins_loaded', '\annonces\load_tgm_plugin_activation' );
	}
}
...
if ( ! class_exists( '\annonces\TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends \WP_List_Table {
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-install' === $this->current_action() || 'tgmpa-bulk-update' === $this->current_action() ) {
				...
				$installer = new \annonces\TGMPA_Bulk_Installer(
					new \annonces\TGMPA_Bulk_Installer_Skin(
						array(
 ...
 * @since 2.2.0
 */
add_action( 'admin_init', '\annonces\tgmpa_load_bulk_installer' );
if ( ! function_exists( 'tgmpa_load_bulk_installer' ) ) {
	...
	function tgmpa_load_bulk_installer() {
		...
		if ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) {
			...
			if ( ! class_exists( '\annonces\TGMPA_Bulk_Installer_Skin' ) ) {
